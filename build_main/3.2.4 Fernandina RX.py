...
def get_glasses_image_path():
    ...
    cursor = conn.cursor()
    cursor.execute("SELECT path FROM glasses WHERE id = ?", (13,))
...
canvas.create_text(1122.0, 503.0, anchor="nw", text="FERNANDINA RX", fill="#FFFFFF", font=("Clash Display Semibold", 48 * -1))
...
canvas.create_text(1353.0, 599.0, anchor="nw", text="Fernandina RX\n", fill="#FFFFFF", font=("Clash Display Light", 36 * -1))

canvas.create_text(1122.0, 599.0, anchor="nw", text="Model Name: ", fill="#FFFFFF", font=("Clash Display Medium", 36 * -1))

canvas.create_text(1353.0, 645.0, anchor="nw", text="Brushed Gold", fill="#FFFFFF", font=("Clash Display Light", 36 * -1))

canvas.create_text(1122.0, 645.0, anchor="nw", text="Frame Color: ", fill="#FFFFFF", font=("Clash Display Medium", 36 * -1))

canvas.create_text(1303.0, 695.0, anchor="nw", text="Narrow", fill="#FFFFFF", font=("Clash Display Light", 36 * -1))
