...
def get_glasses_image_path():
    ...
    cursor = conn.cursor()
    cursor.execute("SELECT path FROM glasses WHERE id = ?", (27,))
...
canvas.create_text(1122.0, 503.0, anchor="nw", text="WATERWOMAN", fill="#FFFFFF", font=("Clash Display Semibold", 48 * -1))
...
canvas.create_text(1353.0, 599.0, anchor="nw", text="Waterwoman\n", fill="#FFFFFF", font=("Clash Display Light", 36 * -1))

canvas.create_text(1122.0, 599.0, anchor="nw", text="Model Name: ", fill="#FFFFFF", font=("Clash Display Medium", 36 * -1))

canvas.create_text(1353.0, 645.0, anchor="nw", text="Shiny Wahoo", fill="#FFFFFF", font=("Clash Display Light", 36 * -1))
