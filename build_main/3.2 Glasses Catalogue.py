...
def open_oceanridge():
    selection_script = OUTPUT_PATH / "3.2.1 Ocean Ridge 820.py"
    subprocess.Popen([sys.executable, str(selection_script)])
    

def open_marianatrench():
    selection_script = OUTPUT_PATH / "3.2.2 Mariana Trench 500.py"
    subprocess.Popen([sys.executable, str(selection_script)])
    

def open_salinarx():
    selection_script = OUTPUT_PATH / "3.2.3 Salina RX.py"
    subprocess.Popen([sys.executable, str(selection_script)])
    

def open_fernandinarx():
    selection_script = OUTPUT_PATH / "3.2.4 Fernandina RX.py"
    subprocess.Popen([sys.executable, str(selection_script)])
