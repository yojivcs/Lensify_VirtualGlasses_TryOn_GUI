...
def get_glasses_image_path():
    ...
    cursor = conn.cursor()
    cursor.execute("SELECT path FROM glasses WHERE id = ?", (12,))
...
canvas.create_text(1122.0, 503.0, anchor="nw", text="TAILFIN", fill="#FFFFFF", font=("Clash Display Semibold", 48 * -1))
...
canvas.create_text(1353.0, 599.0, anchor="nw", text="Tailfin\n", fill="#FFFFFF", font=("Clash Display Light", 36 * -1))
