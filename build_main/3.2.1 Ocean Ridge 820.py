...
def get_glasses_image_path():
    ...
    cursor = conn.cursor()
    cursor.execute("SELECT path FROM glasses WHERE id = ?", (6,))
...
canvas.create_text(1122.0, 503.0, anchor="nw", text="OCEAN RIDGE 820", fill="#FFFFFF", font=("Clash Display Semibold", 48 * -1))
...
canvas.create_text(1353.0, 599.0, anchor="nw", text="Ocean Ridge 820\n", fill="#FFFFFF", font=("Clash Display Light", 36 * -1))

canvas.create_text(1122.0, 599.0, anchor="nw", text="Model Name: ", fill="#FFFFFF", font=("Clash Display Medium", 36 * -1))

canvas.create_text(1353.0, 645.0, anchor="nw", text="Smoke Crystal", fill="#FFFFFF", font=("Clash Display Light", 36 * -1))

canvas.create_text(1122.0, 645.0, anchor="nw", text="Frame Color: ", fill="#FFFFFF", font=("Clash Display Medium", 36 * -1))

canvas.create_text(1303.0, 695.0, anchor="nw", text="Regular", fill="#FFFFFF", font=("Clash Display Light", 36 * -1))

canvas.create_text(1122.0, 695.0, anchor="nw", text="Frame Fit: ", fill="#FFFFFF", font=("Clash Display Medium", 36 * -1))

canvas.create_text(1215.0, 741.0, anchor="nw", text="XL", fill="#FFFFFF", font=("Clash Display Light", 36 * -1))
